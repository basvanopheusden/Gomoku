...
i=${PBS_ARRAYID}
allmodels=(final final_noprune final_nodelta final_noact final_notree final_nocenter final_no2conn final_no2unc final_no3 final_no4 final_nonoise final_diag final_vert final_triangle final_drop_hvd final_drop_type final_opp final_fixed_iters final_fixed_branch final_fixed_depth mcts final_drop_tile final_opt_weights)
allmodels2=(final final final final final final final final final final final final final final final final final final_fixed_iters final_fixed_branch final_fixed_depth mcts final_drop_tile final)
